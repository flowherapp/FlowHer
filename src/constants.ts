...
export const FOCUS_THEMES: FocusTheme[] = [
  {
    ...
    panelBgClass: "bg-white/60 backdrop-blur-xl border border-white/80 shadow-[0_8px_32px_rgba(139,106,174,0.12)]",
  ...
  },
  {
    ...
    panelBgClass: "bg-white/60 backdrop-blur-xl border border-white/80 shadow-[0_8px_32px_rgba(196,132,154,0.14)]",
  ...
  },
  {
    ...
    panelBgClass: "bg-white/60 backdrop-blur-xl border border-white/80 shadow-[0_8px_32px_rgba(90,155,165,0.14)]",
