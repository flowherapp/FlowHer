...
export const FOCUS_THEMES: FocusTheme[] = [
  {
    ...
    panelBgClass: "bg-white/80 backdrop-blur-xl border border-white/90 shadow-[0_16px_48px_rgba(139,106,174,0.20)]",
    panelInnerBgClass: "bg-white/70 backdrop-blur-md border border-[#8B6AAE]/14",
  ...
  },
  {
    ...
    panelBgClass: "bg-white/80 backdrop-blur-xl border border-white/90 shadow-[0_16px_48px_rgba(196,132,154,0.22)]",
    panelInnerBgClass: "bg-white/70 backdrop-blur-md border border-[#C4849A]/16",
  ...
  },
  {
    ...
    panelBgClass: "bg-white/80 backdrop-blur-xl border border-white/90 shadow-[0_16px_48px_rgba(90,155,165,0.22)]",
    panelInnerBgClass: "bg-white/70 backdrop-blur-md border border-[#5A9BA5]/16",
