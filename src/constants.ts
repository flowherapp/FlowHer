...
export const FOCUS_THEMES: FocusTheme[] = [
  {
    ...
    name: "Amethyst Glass",
    emoji: "💜",
    description: "Soft light glassmorphism in your signature jewel purple.",
    bgClass: "fh-glass-light fh-aurora-amethyst bg-[#F7F4FB]",
    textClass: "text-[#2E2440]",
    panelBgClass: "bg-white/55 backdrop-blur-2xl border border-white/75 shadow-[0_16px_48px_rgba(139,106,174,0.22)]",
    panelInnerBgClass: "bg-white/50 backdrop-blur-md border border-[#8B6AAE]/10",
    accentTextClass: "text-[#8B6AAE]",
    accentBgClass: "bg-[#8B6AAE]",
    accentBorderClass: "border-[#8B6AAE]/40",
    accentBorderHoverClass: "hover:border-[#8B6AAE]/60",
    accentBgHoverClass: "hover:bg-[#8B6AAE]/90",
    accentTintClass: "bg-[#8B6AAE]/10",
    textMutedClass: "text-[#2E2440]/55",
    textTitleClass: "text-[#2E2440]",
    logoGradientClass: "from-[#8B6AAE] via-[#C4849A] to-[#5A9BA5]",
    borderClass: "border-[#8B6AAE]/15"
  },
  {
    id: "rosequartz",
    name: "Rose Quartz",
    emoji: "🌸",
    description: "Warm rose glass with gentle blush light.",
    bgClass: "fh-glass-light fh-aurora-rose bg-[#FBF5F6]",
    textClass: "text-[#3A2830]",
    panelBgClass: "bg-white/55 backdrop-blur-2xl border border-white/75 shadow-[0_16px_48px_rgba(196,132,154,0.24)]",
    panelInnerBgClass: "bg-white/50 backdrop-blur-md border border-[#C4849A]/12",
    accentTextClass: "text-[#B26E86]",
    accentBgClass: "bg-[#C4849A]",
    accentBorderClass: "border-[#C4849A]/40",
    accentBorderHoverClass: "hover:border-[#C4849A]/60",
    accentBgHoverClass: "hover:bg-[#C4849A]/90",
    accentTintClass: "bg-[#C4849A]/12",
    textMutedClass: "text-[#3A2830]/55",
    textTitleClass: "text-[#3A2830]",
    logoGradientClass: "from-[#C4849A] via-[#8B6AAE] to-[#D9A78C]",
    borderClass: "border-[#C4849A]/15"
  },
  {
    id: "seaglass",
    name: "Sea Glass",
    emoji: "🌊",
    description: "Cool teal glass, like light through calm water.",
    bgClass: "fh-glass-light fh-aurora-seaglass bg-[#F2F8F8]",
    textClass: "text-[#243B3E]",
    panelBgClass: "bg-white/55 backdrop-blur-2xl border border-white/75 shadow-[0_16px_48px_rgba(90,155,165,0.24)]",
    panelInnerBgClass: "bg-white/50 backdrop-blur-md border border-[#5A9BA5]/12",
    accentTextClass: "text-[#3F818C]",
    accentBgClass: "bg-[#5A9BA5]",
    accentBorderClass: "border-[#5A9BA5]/40",
    accentBorderHoverClass: "hover:border-[#5A9BA5]/60",
    accentBgHoverClass: "hover:bg-[#5A9BA5]/90",
    accentTintClass: "bg-[#5A9BA5]/12",
    textMutedClass: "text-[#243B3E]/55",
    textTitleClass: "text-[#243B3E]",
    logoGradientClass: "from-[#5A9BA5] via-[#7ABFC4] to-[#8B6AAE]",
    borderClass: "border-[#5A9BA5]/15"
  },
  {
    id: "moonlight",
    name: "Moonlight Glass",
    emoji: "🌙",
    description: "Deep plum night with luminous lavender glass.",
    bgClass: "fh-aurora-moonlight bg-[#181026]",
    textClass: "text-[#F2EDF8]",
    panelBgClass: "bg-white/[0.07] backdrop-blur-xl border border-white/10 shadow-[0_8px_32px_rgba(0,0,0,0.35)]",
    panelInnerBgClass: "bg-white/[0.05] backdrop-blur-md border border-white/8",
    accentTextClass: "text-[#B79BD8]",
    accentBgClass: "bg-[#8B6AAE]",
    accentBorderClass: "border-[#B79BD8]/40",
    accentBorderHoverClass: "hover:border-[#B79BD8]/60",
    accentBgHoverClass: "hover:bg-[#8B6AAE]/90",
    accentTintClass: "bg-[#B79BD8]/12",
    textMutedClass: "text-[#F2EDF8]/55",
    textTitleClass: "text-white",
    logoGradientClass: "from-[#8B6AAE] via-[#C4849A] to-[#7ABFC4]",
